...
func _on_level_1_complete():
	...
	await aptyp("doesn't matter, here is one of the ingredients", 0.05, 2.0)
	# give nig ingredient or something
...
func _on_level_4_complete():
	...
	await aptyp("")
	# give final ingredient
	# play giga game ending animation
	# game finished yay
